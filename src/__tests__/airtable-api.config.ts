  ...
  tables: [
    ...
    },
    {
      ...
      focusColumns: [
        ...
        'Allowed Project Countries ',
        'Assignments',
        'Client Brand',
        'Client Name',
        'Client',
        'Current Team Countries',
        'Departments',
        'Description',
        'Entity',
        'Group Name (from Entity)',
        ...
        'Project',
        'REQs',
        'Required Country (from Client)',
        'Requires Background Check',
        'Resourcing',
        'Restricted Country (from Client)',
        'Restricted Project Countries',
        'Role (from REQs)',
        'SOWs',
        'Status',
        'TZ Alignment',
        'Team Member Country Rollup (from Resourcing)',
        'Team Member Ids',
        'Team Members',
        'Teams',
        'companyId',
      ...
      columnNameToObjectPropertyMapper: {
        ['Additional Information']: 'additionalInformationLink',
        ['Client']: {
          propertyName: 'client',
          prefersSingleRecordLink: true,
        },
        ['Open REQs Count']: 'openREQsCount',
        ['Project']: 'name',
