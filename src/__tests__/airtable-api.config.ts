  ...
  tables: [
    ...
    },
    {
      ...
      columnNameToObjectPropertyMapper: {
        ...
        ['Practical Assignment']: 'practicalAssignments',
        ['rating-overall']: 'overallRating',
        ['REQs']: {
          prefersSingleRecordLink: true,
          propertyName: 'req',
        },
        ['REQ (from REQs)']: 'req.name',
        ['role']: 'roleName',
        ['position']: 'positionName',
        ['team-member-type']: {
          prefersSingleRecordLink: true,
          propertyName: 'teamMemberType',
        },
        ['Supported Country (from team-member-type)']: {
          propertyName: 'teamMemberType.supportedCountryIds',
          isLookupWithListOfValues: true,
        },
        ['Benefits Overview']: 'teamMemberType.benefitsOverviewLink',
        ['opportunity-id']: 'opportunityId',
      },
      views: ['Late Stage - Ready For Practical'],
    },
  ],
